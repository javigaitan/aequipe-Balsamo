        ...
        {isMobileMenuOpen && (
          <div className="md:hidden py-4 border-t border-white/10">
            <div className="flex flex-col gap-4">
              <Link
                href="#nosotros"
                className="cursor-pointer font-heading font-bold text-2xl uppercase tracking-normal text-white hover:text-[#F7E95E] transition-colors py-2"
              ...
              <Button
                asChild
                className="cursor-pointer font-heading  text-4xl uppercase tracking-normal bg-[#F7E95E] hover:bg-[#1f97ab] text-{#1f97ab} hover:text-slate-900 transition-colors"
              >
