        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          >
            ...
            <div className="inline-block">
              <img src="/images/logoaequipe.png" alt="Aequipe" className="h-18 w-auto" />
            </div>
          </motion.div>
            ...
            <div className="space-y-2">
              {[
                ...
                <motion.a
                  ...
                  href={link.href}
                  whileHover={{ x: 5 }}
                  className="block text-slate-300 hover:text-[#FFD700] transition-colors duration-200 text-s"
                >
                  {link.name}
                </motion.a>
              ))}
          ...
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <motion.div whileHover={{ scale: 1.02 }} className="text-slate-500 text-lg text-center md:text-right">
              <a
                ...
                className="block"
              >
                <p className="opacity-70 hover:opacity-100 transition-opacity duration-200 text-m">
                  Created by <span className="text-[#F7E95E] font-medium">Gaitán Javier Emanuel</span> -{" "}
                  <span className="text-[#1f97ab] font-medium">Tab Soluciones</span>
                </p>
              </a>
            </motion.div>
          </div>
